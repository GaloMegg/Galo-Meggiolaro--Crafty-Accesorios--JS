...
//funcion construtora para los mensajes nuevos guardados en forma de objetos
class SendMesage {
  constructor(
    userName,
    secondName,
...
//FORM.JS se previene el evento default del button summit y se empiezan a tomar los valores de los campos, se crea un nuevo objeto con la funcion constructora y se pushea el objeto al array que conserva todos los mensajes enviados en el array para ser manipulados por el back, y se resetea el formulario.
function SentForm(e) {
  e.preventDefault();
